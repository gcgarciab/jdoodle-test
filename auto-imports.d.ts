...
export {}
declare global {
  const ComponentMountingOptions: typeof import('@vue/test-utils')['ComponentMountingOptions']
  const EffectScope: typeof import('vue')['EffectScope']
  const QUESTIONS: typeof import('./src/common/constants/questions')['QUESTIONS']
  const QuasarOptions: typeof import('./src/plugins/quasar')['QuasarOptions']
  const axios: typeof import('./src/plugins/axios')['default']
  ...
  const requests: typeof import('./src/plugins/axios')['requests']
